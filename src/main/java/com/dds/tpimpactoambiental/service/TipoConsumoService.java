...
import com.dds.tpimpactoambiental.repository.TipoConsumoRepository;
...
public class TipoConsumoService {
    ...
    @Autowired
    private TipoConsumoRepository repository;
    ...
    private void seedTiposDeConsumoParaAlcanceEmisionesDirectas() {
        ...
        repository.saveAll(Arrays.asList(gasNatural, dieselGasoil, kerosene, fuelOil, nafta, carbon, carbonDeLenia, lenia, combustibleConsumidoGasoil, combustibleConsumidoGNC, combustibleConsumidoNafta));
    }
    ...
    private void seedTiposDeConsumoParaAlcanceEmisionesIndirectas() {
        ...
        repository.saveAll(Arrays.asList(electricidad));
    }
    ...
    private void seedTiposDeConsumoParaAlcanceOtrasEmisionesIndirectas() {
        ...
        repository.saveAll(Arrays.asList(categoriaDeProductoTransportado, medioDeTransporte, distanciaMediaRecorrida, pesoTotalTransportado));
    }

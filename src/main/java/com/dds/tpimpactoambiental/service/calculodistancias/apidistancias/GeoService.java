package com.dds.tpimpactoambiental.service.calculodistancias.apidistancias;


import com.dds.tpimpactoambiental.config.GeoApiConfig;
...
import com.dds.tpimpactoambiental.repository.PaisRepository;
import com.dds.tpimpactoambiental.service.calculodistancias.apidistancias.dtos.*;
...
public class GeoService {
    ...
    private ApiDistanciasService apiDistanciasService;
    @Autowired
    ...
    public GeoService() {
        ...
        OkHttpClient client = new OkHttpClient.Builder().addInterceptor(chain -> {
            Request requestWithAuthentication = chain.request()
                    .newBuilder()
                    .addHeader("Authorization", "Bearer " + "dbNsJcYAneNbF8+i9DX735F7KR7mPZVELmu1wN+Nx0o=")
                    .build();
